...
class BuyerComplainWaiting extends React.Component {
  ...
  componentWillReceiveProps (nextProps) {
    ...
    if (!isFetching(dataDispute) && this.submitting.waiting) {
...
const mapStateToProps = (state) => {
  return {
    dataDispute: state.buyerComplainedOrders
  }
}
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    getDisputeList: (params) => dispatch(transactionAction.getComplainedOrdersBuyer(params))
  }
}

export default connect(mapStateToProps, mapDispatchToProps)(BuyerComplainWaiting)
