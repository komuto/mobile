...
// Styles
import styles from './Styles/BalanceHistoryComissionStyle'

class BalanceHistoryComission extends React.Component {
  ...
  render () {
    ...
    const paidMoney = this.maskedMoney(comission)
    return (
      <View style={styles.container}>
        <ScrollView>
          {this.renderData('Jenis Transaksi', 'Komisi Reseller')}
...
export default connect(mapStateToProps, mapDispatchToProps)(BalanceHistoryComission)
