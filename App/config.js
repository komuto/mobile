...
export const apiKomuto = 'https://api.komuto.skyshi.com/' // 'https://api.mobiledev.komuto.com/'
export const baseUrl = 'https://komuto.skyshi.com/'
export const marketplace = 'Galaxy Parabola'
