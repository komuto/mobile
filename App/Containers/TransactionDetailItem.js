...
// Styles
import styles from './Styles/TransactionDetailItemStyle'

class TransactionDetailItem extends React.Component {
...
export default connect(mapStateToProps, mapDispatchToProps)(TransactionDetailItem)
