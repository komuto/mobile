...
class InfoHargaDanSpesifikasiProdukScreenScreen extends React.Component {
  ...
  modalDropshipping () {
    return (
      <Modal
        ...
        <TentangDropshipping marginNavbars={0} visibleButton={false} />
      </Modal>
    )
  }
...
export default connect(mapStateToProps, mapDispatchToProps)(InfoHargaDanSpesifikasiProdukScreenScreen)
