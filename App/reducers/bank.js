...
export const getDetailBankAccounts = (state = initDetailBankAccounts, action) => {
  const type = buildType(action.type)
  switch (type) {
    case actions.GET_DETAIL_BANK_ACCOUNTS:
      return buildReducer(state, action, type, 'detailBankAccounts')
    default:
      return state
  }
}
