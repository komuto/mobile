...
class UploadPhotoProdukScreenScreen extends React.Component {
  ...
  componentWillReceiveProps (nextProps) {
    if (nextProps.dataPhoto.status === 200) {
      ...
      NavigationActions.infonamadankategori({
...
export default connect(mapStateToProps, mapDispatchToProps)(UploadPhotoProdukScreenScreen)
