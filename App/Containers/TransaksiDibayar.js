...
class TransaksiDibayar extends React.Component {
  ...
  detailBarang (statusBarang) {
    NavigationActions.transaksidetailstatus({
...
export default connect(mapStateToProps, mapDispatchToProps)(TransaksiDibayar)
