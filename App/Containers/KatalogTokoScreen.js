...
class KatalogTokoScreenScreen extends React.Component {
  ...
  componentWillReceiveProps (nextProps) {
    if (nextProps.dataCatalog.status === 200) {
      ...
      NavigationActions.tambaheditkatalog({
...
export default connect(mapStateToProps, mapDispatchToProps)(KatalogTokoScreenScreen)
