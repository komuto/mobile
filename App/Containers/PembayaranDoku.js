...
// Styles
import styles from './Styles/PembayaranDokuStyle'

class PembayaranDoku extends React.Component {
    ...
    return (
      <View style={styles.infoContainer}>
        <View style={styles.titleContainer}>
          <Text style={[styles.textBold, { flex: 1 }]}>Akun Doku Anda</Text>
          <Image source={Images.norton} style={styles.image} />
          <Image source={Images.doku} style={styles.image} />
        </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(PembayaranDoku)
