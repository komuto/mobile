...
class KelolaAlamatTokoScreenScreen extends React.Component {
  ...
  handleEditAlamat () {
    ...
    NavigationActions.updatealamattoko({
...
export default connect(mapStateToProps, mapDispatchToProps)(KelolaAlamatTokoScreenScreen)
